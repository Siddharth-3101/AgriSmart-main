export const INDIAN_STATES_DISTRICTS = {
  "Andhra Pradesh": [
    "Ananthapuramu", "Anakapalli", "Annamayya", "Bapatla", "Chittoor", "East Godavari",
    "Eluru", "Guntur", "Kakinada", "Konaseema", "Kurnool", "Nandyal", "NTR", "Palnadu",
  ...
  "Haryana": [
    ...
    "Hissar", "Jhajjar", "Jind", "Kaithal", "Karnal", "Kurukshetra", "Mahendragarh",
...
export const ALL_STATES = Object.keys(INDIAN_STATES_DISTRICTS);

export const getDistrictsForState = (stateName) => {
  if (!stateName) return [];
  const key = Object.keys(INDIAN_STATES_DISTRICTS).find(
    (s) => s.toLowerCase() === stateName.trim().toLowerCase()
  );
  return key ? INDIAN_STATES_DISTRICTS[key] : [];
};
